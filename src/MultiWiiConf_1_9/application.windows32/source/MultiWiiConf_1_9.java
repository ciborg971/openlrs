...
public class MultiWiiConf_1_9 extends PApplet {
...
public void WRITE() {
  ...
  int p = 0;
   ...
   for(int i =0;i<34;i++)    g_serial.write(PApplet.parseChar(s[i]));
}
...
class cGraph {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#ECE9D8", "MultiWiiConf_1_9" });
  }
}
