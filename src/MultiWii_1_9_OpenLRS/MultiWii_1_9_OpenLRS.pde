// *****************************************************************
// ***************     OpenLRS Rx v2 Multi Code       **************
// ***     OpenLRS Designed by Melih Karakelle on 2010-2012      ***
// **    an Arudino based RC Rx with Multicopter Control          **
// **       This Source code licensed under GPL                   **
// ** The original MultiWiiCopter code writen by  Alexandre Dubus **
// *****************************************************************
// Version Number     : 1.11
...
/*
Original MultiWiiCopter by Alexandre Dubus
www.multiwii.com
November  2011     V1.9
...
void setup() {
  ...
  checkPots(); // Flytron OpenLRS Multi hardware pots
...
void loop () {
  ...
  if (currentTime > rcTime ) { // 50Hz
    ...
    #if !(defined(SPEKTRUM) || defined(BTSERIAL) || defined(OpenLRS))
      computeRC();
    #endif
