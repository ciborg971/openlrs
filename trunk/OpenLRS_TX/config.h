...
// This code part changed after v1.11
// In current code you dont need to code change for booster mode setup. 
// Just press the button and hold when tx off,power on tour tx, You will hear one long beep, then it will short beep in every seconds, count the short beeps.
// release the button after first short beep. The tx module will reduce the output power to 17dbm. 
// This is temporary setting, just turn off and on again your tx to return maximum (20dbm) output power.
