...
void setup() { 
	...
	pinMode(SCLK_pin, OUTPUT); //SCLK
        ...
        #if (TELEMETRY_MODE == 2) 
          pinMode(IR_SENSOR_INPUT, INPUT); //CH9 is IR sensor input on WARBIRD mode for v2 receivers        
        #endif
  ...
  if (receiver_mode==0) // Parallel PPM
    ...
    switch (Servo_Number) {
      ...
      case 7:
        Servo8_OUT_HIGH;
        break;
      #if (TELEMETRY_MODE != 2) // except WARBIRD Mode
      case 8:
        Servo9_OUT_HIGH;
        break;  
      #endif
				 ...
				 /*
						...
						Red_LED_ON;
                                ...
                                delay(1);
                                    ...
                                    #if (TELEMETRY_MODE==2) 
                                         Telemetry_Hit(); // Send the IR bullet hits over telemetry for WarBird Mode
                                     #endif    
